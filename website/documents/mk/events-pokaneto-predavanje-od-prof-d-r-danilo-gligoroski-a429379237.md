...
url: https://finki.ukim.mk/events/pokaneto-predavanje-od-prof-d-r-danilo-gligoroski/
language: mk
source_kind: rest
...
# Покането предавање од проф\. д\-р Данило Глигороски
...
Повеќе информации за предавачот може да погледнете на следниот [линк](http://www.ntnu.edu/employees/danilo.gligoroski).
