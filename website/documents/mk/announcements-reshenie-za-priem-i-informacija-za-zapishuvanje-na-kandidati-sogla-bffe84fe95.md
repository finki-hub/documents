...
url: https://finki.ukim.mk/announcements/reshenie-za-priem-i-informacija-za-zapishuvanje-na-kandidati-soglasno-reshenieto-za-priem-vo-prv-upisen-rok-2023-2024/
language: mk
source_kind: rest
modified: 2023-09-07T12:00:00
wordpress_id: 17566
wordpress_type: announcement
-->

# Решение за прием и информација за запишување на кандидати согласно решението за прием во прв уписен рок 2023/2024

Почитувани кандидати, ве известуваме дека запишувањето на рангираните кандидати според [**решението за прием**](https://oldsite.finki.ukim.mk/sites/default/files/u620/rang-lista-finalna.pdf) (нерангираните кандидати кои дале изјава се рангирани со дополнително решениe на крајот од документот, т.е. ги има 2 пати) во првиот уписен рок ќе се изврши на **12.09.2023** во просторија 117 (на истото место каде се поднесуваа документите) според следниот распоред:
...
- Рангирани на Software engineering and information systems (**SEIS**) и Стручни студии за програмирање (**ССП**) од **11:30 часот**
- Рангирани на Интернет, мрежи и безбедност (**ИМБ**) и Компјутерско инженерство (**КИ**) од **12:00 часот**
- Рангирани на Компјутерски науки (**КН**) и Информатичка едукација (**ИЕ**) од **13:30 часот**

Им пожелуваме успех на сите идни студенти на ФИНКИ!

**Напомена:**Направено е прерангирање поради прифатените приговори.
...
Кандидатите кои нема да се запишат или се откажуваат од запишувањето на Факултетот за информатички науки и компјутерско инженерство во учебната 2023/2024, поднесените документи можат да ги **повлечат до 16.9.2023 (09 – 12:00 часот)**. При тоа, потребно е да се потпише [**изјава**](https://oldsite.finki.ukim.mk/sites/default/files/u620/izjava_za_podignuvanje_na_dokumentite_1.pdf) за подигнување на документите во 2 примероци.
