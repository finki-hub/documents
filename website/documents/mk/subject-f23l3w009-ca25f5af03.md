...
url: https://finki.ukim.mk/subject/F23L3W009/
language: mk
...
| 22. | Литература | |  |  | | --- | --- | | 22.1. | **Задолжителна литература** 1. Brett D. McLaughlin, Gary Pollice и Dave West | Head First Објектно ориентирана анализа и дизајн | Просветно дело | 2009 2. Eric Freeman, Elisabeth Robson, Bert Bates and Kathy Sierra | Head First Design Patterns | O`Reilly Media | 2004 | | 22.2. | **Дополнителна литература** Ред.бр. Автор Наслов Издавач Година | |
