...
url: https://finki.ukim.mk/announcements/konkurs-za-letna-studentska-praksa-stazhiranje-vo-ramki-na-programata-erazmus-ka-103-za-uchebnata-2018-2019-godina/
language: mk
source_kind: rest
modified: 2019-02-28T12:00:00
wordpress_id: 17902
wordpress_type: announcement
-->

# Kонкурс за летна студентска пракса/стажирање во рамки на програмата еразмус\+ \(ka 103\) за учебната 2018/2019 година
...
Кандидатите лично ја поднесуваат апликацијата до Еразмус+ координаторот на факултетот каде студираат најдоцна **до** **31 март** **201****9** **година, во три примерока: е*ден примерок до Еразмус+ коррдинаторот, еден примерок до Ректоратот на УКИМ и еден примерок задржува студентот*.**
