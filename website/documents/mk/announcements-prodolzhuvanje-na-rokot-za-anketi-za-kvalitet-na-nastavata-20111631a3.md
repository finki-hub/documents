...
url: https://finki.ukim.mk/announcements/prodolzhuvanje-na-rokot-za-anketi-za-kvalitet-na-nastavata/
language: mk
source_kind: rest
modified: 2018-02-28T12:00:00
wordpress_id: 17942
wordpress_type: announcement
-->

# Продолжување на рокот за анкети за квалитет на наставата

Почитувани студенти, со цел унапредување на наставата и зголемување на нејзиниот квалитет, на ФИНКИ е направен систем за анонимни студентски анкети. Системот е достапен на [students.finki.ukim.mk](http://students.finki.ukim.mk/), на линкот Анкети. Системот е развиен до страна на развојниот тим на ФИНКИ составен од постдипломци и претставници на СП ФИНКИ, сé со цел да се гарантира целосната анонимност на одговорите на студентите.
