...
url: https://finki.ukim.mk/en/subject/F18L3S121/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Blockchain and Cryptocurrencies  Blockchain and cryptocurrencies |
| 2. | Code | F18L3S121 |
| 3. | Study Programme | — |
...
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | Cryptography or Information Security |
| 10. | Objectives of the course programme (competences) | The goal of this course is to enable students to understand how cryptocurrencies work, and the ideas, technologies, and organizations that support them or arise from them. |
| 11. | Course content | 1. Introduction and History  2. Protocol and Consensus - Overview  3. Storing Cryptocurrencies - Cryptography and Wallets  4. Bitcoin mechanisms and optimizations  5. Cryptocurrency Mining  6. Game Theory and Network Attacks - How to Destroy Bitcoin  7. Ethereum and Smart Contracts:  8. Alternative consensus  9. Organizational Block Chains  10. Regulations and Anonymity  11. Anonymity Techniques, Protocols and Altcoins  12. Advanced Topics and the Future |
