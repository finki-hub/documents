...
url: https://finki.ukim.mk/en/events/digital-forensics-evidence-analysis-via-intelligent-systems-and-practices-digforasp/
language: en
source_kind: rendered
-->

# Digital forensics: evidence analysis via intelligent systems and practices – DigForASP – ФИНКИ
...
Доколку ве интересираат повеќе информации и/или сакате да се приклучите на настанот, ве молиме пратете е-маил на следната адреса: [Aleksandra.kanevche@finki.ukim.mk](mailto:Aleksandra.kanevche@finki.ukim.mk).
