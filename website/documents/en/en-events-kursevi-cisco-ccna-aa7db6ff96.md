...
url: https://finki.ukim.mk/en/events/kursevi-cisco-ccna/
language: en
source_kind: rendered
-->

# Курсеви CISCO CCNA – ФИНКИ

Курсевите CISCO CCNA (CCNA1 R&S – Introduction to Networks) **почнуваат** од вторник**, 25.10.2016** in **16ч.** во просторија **115** на Финки.

Сите заинтересирани студенти што сеуште не се пријавени, да се пријават на емаил **најдоцна до вторник, 25.10.2016,** to **12ч**. за да бидат навреме вклучени.
