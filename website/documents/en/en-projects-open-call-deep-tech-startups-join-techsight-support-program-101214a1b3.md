...
url: https://finki.ukim.mk/en/projects/open-call-deep-tech-startups-join-techsight-support-program/
language: en
source_kind: rendered
-->

# Open Call for Deep Tech Startups – Join the TECHSIGHT Support Program\! – ФИНКИ
...
The program is part of the TECHSIGHT project (2025–2027) funded by the EIT Higher Education Initiative, a Horizon Europe program, which aims to position European universities as global leaders in deep tech innovation.
...
**Note:** While Phase 1 is envisioned as an entry point, all startups will be able to remain part of the TECHSIGHT Coordination Mechanism after December 2025. Phase two will offer various ongoing activities, valuable resources on our TECHSIGHT CollabSphere platform, and future open calls.
...
[**Apply here: [link]**](https://docs.google.com/forms/d/e/1FAIpQLSdXontr1nVBvUpsPePouYwa_poFk6aFCVBmSpE7TV1MmGe_CQ/viewform)
...
For any additional questions, contact us at: **[techsight@cpn.rs](mailto:techsight@cpn.rs)**
...
- Yıldız Technical University (Turkey) – Project Coordinator
