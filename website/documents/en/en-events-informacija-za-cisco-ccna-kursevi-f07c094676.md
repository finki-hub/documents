...
url: https://finki.ukim.mk/en/events/informacija-za-cisco-ccna-kursevi/
language: en
source_kind: rendered
-->

# Информација за CISCO CCNA курсеви – ФИНКИ

Курсевите CISCO CCNA (CCNA1 R&S – Introduction to Networks) **почнуваат**од четврток**,** **25****.10.201****8** in **16ч.**во просторија **116**на Финки.

Сите заинтересирани студенти што сè уште не се пријавени, да се пријават на емаил **најдоцна до четврток,** **25****.10.2018,**to**12ч**. за да бидат навреме вклучени.
