...
url: https://finki.ukim.mk/en/subject/F18L1S045/
language: en
...
| 2. | Code | F18L1S045 |
| 3. | Study Programme | Internet, Networks and Security, Computer Education, Computer Engineering |
...
| 10. | Objectives of the course programme (competences) | Understanding the main computer architectures, evaluating the performance of individual components and the computer system as a whole. |
| 11. | Course content | Introduction to computer systems. Overview of computer architectures and computational structures. Capacity and performance of computer systems. Machine representation of numbers. Arithmetic algorithms. Arithmetic logic unit organization. Instruction formats. Instruction processing and operations. Pipelined design techniques, look-ahead, multifunctional units. Virtual machines. Virtual memory. Main memory management. Parameters of memory systems. Typical memory organizations. Types of interconnect networks. Real I/O schemes. Secondary storage devices. Disks. |
