...
url: https://finki.ukim.mk/en/subject/F18L2W046/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Computer networks  Computer networks |
| 2. | Code | F18L2W046 |
| 3. | Study Programme | Internet, Networks and Security, Computer Engineering |
| 4. | Organizer of the study programme (unit, institute, department or division) | Faculty of Computer Science and Engineering |
| 5. | Degree level (first, second, third cycle) | First Cycle |
| 6. | Academic year / semester | 3 / Winter |
| 7. | Number of ECTS credits | 6 |
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | Computer architectures |
