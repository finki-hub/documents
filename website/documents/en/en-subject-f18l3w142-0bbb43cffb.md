...
url: https://finki.ukim.mk/en/subject/F18L3W142/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Natural language processing  Natural language processing |
| 2. | Code | F18L3W142 |
| 3. | Study Programme | — |
...
| 10. | Objectives of the course programme (competences) | The goal of the course is for students to acquire the basic theoretical and practical knowledge of natural language processing algorithms. They will acquire knowledge of how linguistic structure and meaning are represented in data structures, how these structures and meanings are recognized in textual data, and, most importantly, how to build algorithms that will identify the correct answers among a large number of options. |
| 11. | Course content | Introduction; Basic Text Processing; Morphology; Syntax, Semantics, and Ambiguity of Natural Languages; Word Morphology and Finite Automata; Modeling Natural Languages; Basic Algorithms for Spelling Correction; Word Stemming; Parsing; Text Classification; Fundamentals of Machine Translation; Basic Algorithms for Information Extraction from Text Data; |
