...
url: https://finki.ukim.mk/en/subject/F18L3W058/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Independent project  Individual project |
| 2. | Code | F18L3W058 |
...
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | earned a minimum of 150 credits |
| 10. | Objectives of the course programme (competences) | The goal of the course is for students, using modern e-learning tools, to independently develop a curriculum for an elementary or secondary education subject of their choice. |
| 11. | Course content | The development of the program should include learning materials, practice examples, and tests and forms for evaluating learning. |
