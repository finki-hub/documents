...
url: https://finki.ukim.mk/en/subject/F18L3W145/
language: en
...
| 11. | Course content | Introduction to optical networks. Signal propagation through optical fibers. Optical components and modulation. Optical layer clients (SONET/SDH, OTN). WDM network elements. Control and management of optical networks. Control and management of optical networks. Robustness of optical networks. WDM network design. Dynamic routing and spectrum allocation. Access optical networks. Packet switching. Various aspects in examples of real optical networks. |
