...
url: https://finki.ukim.mk/en/announcements/prijavuvanje-ispiti-za-studenti-na-ii-ciklus-4/
language: en
source_kind: rendered
-->

# Пријавување испити за студенти на II циклус – ФИНКИ
...
Пријавувањето на проблем се врши преку тикет системот, на адресата [http://help.students.finki.ukim.mk](http://help.students.finki.ukim.mk/).
