...
url: https://finki.ukim.mk/en/subject/F18L3W148/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Fundamentals of Robotics  Introduction to robotics |
| 2. | Code | F18L3W148 |
| 3. | Study Programme | — |
...
| 10. | Objectives of the course programme (competences) | Upon completion of this course, the student is expected to have knowledge of the principles of robot development and systems that include sensors and effectors. Students will become familiar with methods of programming robots that enable their control. Students will become familiar with the applications of robots in industry and society. |
| 11. | Course content | Introduction to robotics. Sensors in robotics. Effectors in robotics. Kinematics and dynamics of robotic systems. Software systems for robot control. Learning in robots. Robots as intelligent agents. Robots in industry. Autonomous robots. Application of robots in society, manufacturing processes, and medicine. |
