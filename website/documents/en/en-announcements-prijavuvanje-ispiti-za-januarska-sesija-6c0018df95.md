...
url: https://finki.ukim.mk/en/announcements/prijavuvanje-ispiti-za-januarska-sesija/
language: en
...
Најавувањето е преку централниот автентикациски сервис на ФИНКИ (CAS) преку адресата: [http://finki.iknow.ukim.edu.mk](http://finki.iknow.ukim.edu.mk/). Problem reporting is done through the ticket system at the address [http://help.students.finki.ukim.mk](http://help.students.finki.ukim.mk/). При пријаувањето на проблем со задолжително изберете тема: Пријавување испити, бидејќи така се гарантира дека вашиот проблем ќе биде проследен на вистинското место во најкраток рок.
