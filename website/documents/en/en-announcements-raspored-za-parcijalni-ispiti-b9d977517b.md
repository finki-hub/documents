...
url: https://finki.ukim.mk/en/announcements/raspored-za-parcijalni-ispiti/
language: en
source_kind: rendered
-->

# Распоред за парцијални испити – ФИНКИ

Dear Students,

On [**the link**](https://oldsite.finki.ukim.mk/sites/default/files/u620/raspored-parcijalni.pdf)е распоредот за полагање на парцијални испити, во деновите од 21.4.2020 до 25.4.2020. Соодветно на тоа, наставата ќе продолжи да се изведува од Понеделник, 27.4.2020 година.
...
For секој предмет во соодветниот курс на системот ispiti.finki.ukim.mk,ќе добиете дополнителни насоки од страна на предметните професори, согласно начинот на полагање.
...
Ги охрабруваме сите студенти навремено да се подготват за да процесот на изведување на парцијални испитand.
