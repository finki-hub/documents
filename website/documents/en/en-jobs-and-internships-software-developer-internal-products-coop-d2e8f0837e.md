...
url: https://finki.ukim.mk/en/jobs-and-internships/software-developer-internal-products-coop/
language: en
source_kind: rendered
-->

# Software Developer, Internal Products – Coop – ФИНКИ
...
Skills:
Experience developing Django Web Apps is a plus
Python programming is preferred, but any other oop language knowledge is acceptable
Experience writing unit and integration tests to ensure code quality
Familiarity with HTML, CSS, and JavaScript
Strong problem-solving abilities, willingness to learn, and capacity to accept feedback in code reviews.
Familiarity with relational databases like PostgreSQL or MySQL.

Must be comfortable working remotely and collaborating asynchronously with teammates in different timezones.
Ability to work independently as well as in a team environment
Excellent oral and written communication skills

You will be exposed to:
Building server-side logic, database models, and views using Django.
Creating and integrating REST APIs, often using the Django REST Framework.
Troubleshooting issues and fixing bugs in existing applications.
Attending a team event in one of our hubs (UK, USA or Balkans)
...
If you enjoy pizza and already feel like a slicer, we’d love to have you on our team.
