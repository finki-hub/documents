...
url: https://finki.ukim.mk/en/subject/F18L3W136/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Advanced web design  Advanced Web Design |
| 2. | Code | F18L3W136 |
| 3. | Study Programme | — |
...
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | Web Design Basics |
| 10. | Objectives of the course programme (competences) | The goal of the curriculum is to familiarize students with advanced technologies in the field of web design and the development of modern dynamic web applications. Upon completion of the course, students will have an overview of the latest technical advancements in web design and will be able to use them in the creation of practical projects. |
| 11. | Course content | Introduction to the subject. Aesthetics. Responsive CSS. CSS Frameworks, Bootstrap. Web Graphics. Canvas. SVG. Search Engine Optimization. HTML5 Offline. CSS Preprocessors. Internet Marketing. Content Management Systems. SMIL |
