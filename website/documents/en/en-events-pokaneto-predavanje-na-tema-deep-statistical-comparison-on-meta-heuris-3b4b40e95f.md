...
url: https://finki.ukim.mk/en/events/pokaneto-predavanje-na-tema-deep-statistical-comparison-on-meta-heuristic-stochastic-optimization-algorithms/
language: en
source_kind: rendered
-->

# Покането предавање на тема ,,Deep Statistical Comparison on Meta\-heuristic Stochastic Optimization Algorithms“ – ФИНКИ
...
**Lecturer:** Tome Eftimov, PhD, Computer Systems Department, Jožef Stefan Institute, Ljubljana, Slovenia
