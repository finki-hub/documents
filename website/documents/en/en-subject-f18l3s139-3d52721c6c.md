...
url: https://finki.ukim.mk/en/subject/F18L3S139/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Advanced Topics in Cryptography  Advanced Topics in Cryptography |
| 2. | Code | F18L3S139 |
| 3. | Study Programme | — |
...
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | Cryptography |
| 10. | Objectives of the course programme (competences) | Building a secure cryptographic primitive that is resistant not only to theoretical attacks but also to practical (side-channel) attacks. |
| 11. | Course content | Types of cryptographic attacks; Introduction to differential cryptanalysis; Introduction to linear cryptanalysis; Side-channel attacks; Real-world attacks on cryptographic primitives; Programming secure cryptographic software |
