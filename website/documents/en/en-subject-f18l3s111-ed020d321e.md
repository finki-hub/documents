...
url: https://finki.ukim.mk/en/subject/F18L3S111/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Infrastructure programming  Infrastructure coding |
| 2. | Code | F18L3S111 |
| 3. | Study Programme | — |
...
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | System administration |
| 10. | Objectives of the course programme (competences) | The student will acquire knowledge of easily and efficiently managing IT systems, managing traditional  data centers, private and public clouds, and client computers and devices. The student will also be able to become familiar with  Platforms for managing multiple hypervisors, physical resources, and applications. |
| 11. | Course content | Data Center Organization and Management - IT Asset Documentation and Management - Outage and Disaster Protection, Ensuring Service Continuity - Configuration Management and Change Management - Automated Configuration Management - Infrastructure Monitoring (monitoring and measurement) - Log Management - Scripting Languages for Configuration Management |
