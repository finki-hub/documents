...
url: https://finki.ukim.mk/en/subject/F18L2S110/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Internet technologies  Internet technologies |
| 2. | Code | F18L2S110 |
| 3. | Study Programme | — |
...
| 10. | Objectives of the course programme (competences) | Understanding the mechanisms of the HTTP protocol. Familiarization with platforms for developing web applications.  Creation and development of web applications. Creation and use of web services. |
| 11. | Course content | Architecture of dynamic web applications. Web communication. Introduction to Web Application Development. Introduction to ASP.NET. Basics of web forms. Web controls. Master pages and themes. State management. Navigation. Working with databases. Working with databases. Web application security. SOA and web services. MVC |
...
| 19. | Requirement for obtaining a signature and taking the final exam | 30 + 45 + 105 = 180 hours |
