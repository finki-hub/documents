...
url: https://finki.ukim.mk/en/subject/F23L2S095/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Digital image processing  Digital image processing |
| 2. | Code | F23L2S095 |
| 3. | Study Programme | — |
...
| 22. | Literature | |  |  | | --- | --- | | 22.1. | **Required literature** 1. Rafael C. Gonzalez, Richard E. Woods | Digital Image Processing (4th Edition) | Pearson | 2017 2. Prateek Joshi | OpenCV with Python By Example | Packt Publishing | 2015 | | 22.2. | **Additional literature** No. Author Title Publisher Year | |
