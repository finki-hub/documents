...
url: https://finki.ukim.mk/en/subject/F18L3S080/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Web search engines  Web search engines |
| 2. | Code | F18L3S080 |
| 3. | Study Programme | — |
...
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | Natural language processing |
...
| 11. | Course content | Introduction to web search engines; Query processing; Feedback-based search; Vector spaces; Document structure; Index creation; Evaluation of search systems; Document clustering and classification; Information gathering from the web and social networks and their indexing; Personalized search; Question answering algorithms; Image search and indexing; |
...
| 17. | Assessment method | |  |  |  | | --- | --- | --- | | 17.1. | Tests | 0 points | | 17.2. | Seminar paper / project (presentation: written and oral) | 15 points | | 17.3. | Activities and learning | 0 points | | 17.4. | Final exam | 70 points | |
