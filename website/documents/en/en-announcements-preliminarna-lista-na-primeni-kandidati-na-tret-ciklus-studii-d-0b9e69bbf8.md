...
url: https://finki.ukim.mk/en/announcements/preliminarna-lista-na-primeni-kandidati-na-tret-ciklus-studii-doktorski-2/
language: en
...
Во прилог е листата на примени кандидати на конкурсот за упис на трет циклус студии на насоката **Informatics**.
