...
url: https://finki.ukim.mk/en/events/pokaneto-predavanje-na-tema-artificial-intelligence-in-cryptography-challenges-and-opportunities/
language: en
source_kind: rendered
-->

# Покането предавање на тема: Artificial Intelligence in Cryptography: Challenges and Opportunities – ФИНКИ

Гостинското предавање на тема **Artificial Intelligence in Cryptography: Challenges and Opportunities** ќе се одржи на **24.02.2023** со почеток од **15:00** часот во **Амфитеатарот на Финки** by **Stjepan Picek**.
