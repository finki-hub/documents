...
url: https://finki.ukim.mk/en/subject/F18L3S122/
language: en
...
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | Discrete Structures 2 or Discrete Mathematics |
...
| 11. | Course content | Basic Cryptographic Terms, Examples of Historical Ciphers, Symmetric Cryptography: Stream Ciphers and Random Number Generators, Block Ciphers and Modes of Operation, Description of the DES and AES algorithms, Attack scenarios and cryptographic attacks, Public-key cryptography, Description of the RSA and ElGamal algorithms, Digital signatures, Description of the Diffie-Hellman scheme and its application, Hash functions, Application of cryptographic algorithms in information security. |
