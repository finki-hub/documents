...
url: https://finki.ukim.mk/en/subject/F18L3S151/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Computational biology  Computational biology |
| 2. | Code | F18L3S151 |
| 3. | Study Programme | — |
...
| 10. | Objectives of the course programme (competences) | The goal of the course is for students to become familiar with the fundamentals of modern techniques in the field of computational biology. Upon completion of the course, candidates will have in-depth knowledge of advanced technologies and methods for computational biology, dynamical systems, and modeling; will be able to understand, analyze, and formulate general problems in the field of computational biology; will be able to successfully apply methods to solve real-world problems; will be able to design, analyze, implement, and evaluate the performance of methods and models in computational biology. |
| 11. | Course content | Introduction to computational biology. Dynamic models with differential equations. Linear models of structured populations. Nonlinear models of interaction. Modeling molecular evolution. Models in genetics. Modeling viral diseases. Conclusion – contemporary trends in computational biology. |
