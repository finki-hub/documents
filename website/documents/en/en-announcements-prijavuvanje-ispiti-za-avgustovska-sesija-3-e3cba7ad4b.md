...
url: https://finki.ukim.mk/en/announcements/prijavuvanje-ispiti-za-avgustovska-sesija-3/
language: en
source_kind: rendered
-->

# Пријавување испити за августовска сесија – ФИНКИ

Пријавувањето на испитите на ФИНКИ за августовско-септемврискиот испитен рок 2011/2012 година ќе се одвива во периодот од 07.–19.08.2012 година. Сите студенти на ФИНКИ испитите ги пријавуваат на ФИНКИ, без разлика каде ги слушале.

Податоците за студентите се мигрирани од претходните системи и можни се мали неконзистентности. Доколку наидете на недоследности заради миграциите на податоци кои ве спречуваат да пријавите испити, пратете тикет на ТИКЕТИНГ СИСТЕМОТ.
...
Деканат на ФИНКИ, Скопје, 07.08.2012
