...
url: https://finki.ukim.mk/en/subject/F18L3S155/
language: en
...
|  |  |  |
| --- | --- | --- |
| 1. | Course Title | Service-Oriented Architectures  Service-Oriented Architectures |
| 2. | Code | F18L3S155 |
| 3. | Study Programme | — |
...
| 8. | Teacher | — |
| 9. | Prerequisites for enrolling in the course | Web Programming or Internet Technologies or Implementation of Open and Free Source Systems |
...
| 11. | Course content | Introduction to Service-Oriented Architectures - Layers of Services and Microservices - Analysis and Modeling of Software with Web Services - Analysis and Modeling of Software with REST Services and Microservices - Design of a Service API and Contract in Web Services - Software Development Process with a Microservices Architecture - Microservice Architecture System Design - Security Policies and Protection in Service-Oriented Architectures - Organization, Orchestration, and Management of a Microservice Environment |
