...
category: procedures
last_verified: 2026-09-06
title: Процедура за изведување на студентска пракса | ФИНКИ
sha256: 2c1c3e8221c0c5e8fb8fde84b51bc8e7b24856aae55c3e6a8d73dd143d55ad99

Процедурата за изведување, одобрување и евидентирање на студентската пракса се управува преку системот:

[internships.finki.ukim.mk](https://internships.finki.ukim.mk)

Целосниот опис на постапката, правилата и чекорите за пријавување, одобрување и верификација на праксата е достапен на почетната страна на системот.
<!-- finki-static-page:end -->

<!-- finki-static-page:start id=study-guide -->
source_url: https://finki.ukim.mk/mk/studies/study-guide
canonical_url: https://oldsite.finki.ukim.mk/mk/studies/study-guide
language: mk
category: studies
last_verified: 2026-09-06
title: Водич за студирање | ФИНКИ
sha256: 6f4ecc17db4a3f912395d0d72b3433c80f5ea3e461c10fdd04430d0137b78408
